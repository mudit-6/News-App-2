...
frame4.pack()
main_data_window(
    'http://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=0c508a20d8494af19d7b270a5cfb239e', frame4)
# frame5 or tab5
frame5 = tk.Frame(my_notebook)
frame5.pack()
main_data_window(
    'http://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=0c508a20d8494af19d7b270a5cfb239e', frame5)
# frame6 or tab6
frame6 = tk.Frame(my_notebook)
frame6.pack()
main_data_window(
    'http://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=0c508a20d8494af19d7b270a5cfb239e', frame6)
# frame7 or tab7
frame7 = tk.Frame(my_notebook)
frame7.pack()
main_data_window(
    'http://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=0c508a20d8494af19d7b270a5cfb239e', frame7)
# frame8 or tab8
frame8 = tk.Frame(my_notebook)
frame8.pack()
main_data_window(
    'http://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=0c508a20d8494af19d7b270a5cfb239e', frame8)
